...
public final class Colors {
	...
	public static final TextColor GREEN = TextColor.color(0x92FF25);
	public static final TextColor YELLOW_GREEN = TextColor.color(0xDBFF4B);
	...
	public static final TextColor NEUTRAL = CECER;
