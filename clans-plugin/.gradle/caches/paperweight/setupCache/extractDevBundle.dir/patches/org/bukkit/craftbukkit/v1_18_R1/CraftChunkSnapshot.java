...
public class CraftChunkSnapshot implements ChunkSnapshot {
    ...
    public final Biome getBiome(int x, int y, int z) {
        ...
        PalettedContainer<net.minecraft.world.level.biome.Biome> biome = this.biome[this.getSectionIndex(y >> 2)];
        return CraftBlock.biomeBaseToBiome((Registry<net.minecraft.world.level.biome.Biome>) biome.registry, biome.get(x >> 2, (y & 0xF) >> 2, z >> 2));
    }
