...
public class CraftLimitedRegion extends CraftRegionAccessor implements LimitedRegion {
    ...
    public BlockState getBlockState(int x, int y, int z) {
        ...
        return org.bukkit.craftbukkit.v1_18_R1.inventory.CraftMetaBlockState.createBlockState(entity.getBlockState().getBukkitMaterial(), entity.saveWithFullMetadata());
        // Paper end
    }
    ...
    public void setBlockData(int x, int y, int z, BlockData blockData) {
        Preconditions.checkArgument(this.isInRegion(x, y, z), "Coordinates %s, %s, %s are not in the region", x, y, z);
        getHandle().setBlock(new BlockPos(x, y, z), ((org.bukkit.craftbukkit.v1_18_R1.block.data.CraftBlockData) blockData).getState(), 3); // Paper
    }
