...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public Block getTargetBlock(int maxDistance, com.destroystokyo.paper.block.TargetBlockInfo.FluidMode fluidMode) {
        ...
        return !(rayTrace instanceof net.minecraft.world.phys.BlockHitResult) ? null : org.bukkit.craftbukkit.v1_18_R1.block.CraftBlock.at(getHandle().level, ((net.minecraft.world.phys.BlockHitResult)rayTrace).getBlockPos());
    }
    ...
    public com.destroystokyo.paper.block.TargetBlockInfo getTargetBlockInfo(int maxDistance, com.destroystokyo.paper.block.TargetBlockInfo.FluidMode fluidMode) {
        ...
        return !(rayTrace instanceof net.minecraft.world.phys.BlockHitResult) ? null :
            new com.destroystokyo.paper.block.TargetBlockInfo(org.bukkit.craftbukkit.v1_18_R1.block.CraftBlock.at(getHandle().level, ((net.minecraft.world.phys.BlockHitResult)rayTrace).getBlockPos()),
