...
import org.gepron1x.clans.plugin.util.uuid.SerializableUuid;
...
public final class UuidArgumentFactory extends AbstractArgumentFactory<UUID> {
    ...
    protected Argument build(UUID value, ConfigRegistry config) {
        return (position, statement, ctx) -> statement.setBytes(position, new SerializableUuid(value).serialize());
    }
}
