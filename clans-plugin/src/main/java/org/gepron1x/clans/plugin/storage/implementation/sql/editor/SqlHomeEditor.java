...
public class SqlHomeEditor implements HomeEditor {
    private static final String UPDATE_ICON = "UPDATE homes SET icon=<icon> WHERE name=<name> AND clan_tag=<clan_tag>";
    private static final String UPDATE_LOCATION = "UPDATE homes SET x=<x>, y=<y>, z=<z>, world=<world> WHERE name=<name> AND clan_tag=<clan_tag>";
    private static final String UPDATE_DISPLAY_NAME = "UPDATE homes SET display_name=<display_name> WHERE name=<name> AND clan_tag=<clan_tag>";
