    ...
    public static void main(String[] args) {
        ...
        OptionParser parser = new OptionParser() {
            {
                ...
                acceptsAll(Main.asList("noorg.bukkit.craftbukkit.libs.jline"), "Disables org.bukkit.craftbukkit.libs.jline and emulates the vanilla console");
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                ...
                String org.bukkit.craftbukkit.libs.jline_UnsupportedTerminal = new String(new char[]{'j', 'l', 'i', 'n', 'e', '.', 'U', 'n', 's', 'u', 'p', 'p', 'o', 'r', 't', 'e', 'd', 'T', 'e', 'r', 'm', 'i', 'n', 'a', 'l'});
                String org.bukkit.craftbukkit.libs.jline_terminal = new String(new char[]{'j', 'l', 'i', 'n', 'e', '.', 't', 'e', 'r', 'm', 'i', 'n', 'a', 'l'});

                Main.useJline = !(org.bukkit.craftbukkit.libs.jline_UnsupportedTerminal).equals(System.getProperty(org.bukkit.craftbukkit.libs.jline_terminal));

                if (options.has("noorg.bukkit.craftbukkit.libs.jline")) {
                ...
                if (Main.useJline) {
                    ...
                    // This ensures the terminal literal will always match the org.bukkit.craftbukkit.libs.jline implementation
                    System.setProperty(org.bukkit.craftbukkit.libs.jline.TerminalFactory.JLINE_TERMINAL, org.bukkit.craftbukkit.libs.jline.UnsupportedTerminal.class.getName());
                }
                */
            ...
            tryPreloadClass("org.org.bukkit.craftbukkit.libs.jline.terminal.impl.MouseSupport");
            tryPreloadClass("org.org.bukkit.craftbukkit.libs.jline.terminal.impl.MouseSupport$1");
            tryPreloadClass("org.org.bukkit.craftbukkit.libs.jline.terminal.Terminal$MouseTracking");
